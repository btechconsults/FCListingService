...
def ScrapeForeHtml(salemonth,county,saledate):
	...
	filename = './target/' + salemonth + '/fc-final-' + salemonth + '.csv'
...
def main(argv):
	...
	try:
		...
		print ("------------------------------------------------ ")
		print ('2: Running Foreclosurebidslist: ')
		...
		print ('The total number of records found in ',count,', counties: ',total)

		src  = './target/' + month + '/fc-final-' + month + '.csv'
		dest = '../../target/' + month + '/fc-final-' + month + '-02.csv'
		...
		strRecord ='Foreclosurebidslist|' + str(total) + '|' + 'https://www.foreclosurebidslist.com|' + './2-Foreclosurebidslist/target/' + month +  '/fc-final-' + month  + '-.csv'
